...
updated: 2026-05-05
type: concept
tags: [agent, multi-agent, anthropic, research, tool-use]
sources: [raw/articles/anthropic-10-multi-agent-research-system.md]
...
## 相关链接
- [[anthropic-building-effective-agents]] — Agent 设计模式（workflow vs agent 的区分）
