---
title: "面向 AI Agent 的有效 Context Engineering"
created: 2026-05-05
updated: 2026-05-05
type: concept
...
这种注意力稀缺性源于 LLM 的架构约束。LLM 基于 transformer 架构，该架构使得每个 token 都能关注整个 context 中的所有其他 token。这对 n 个 token 产生了 n² 的成对关系。
